...
import AlbumsFilterPage from "./Pages/AlbumsFilterPage/AlbumsFilterPage";
import ArtistsFilterPage from "./Pages/ArtistsFilterPage/ArtistsFilterPage";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/albumsFilter" element={<AlbumsFilterPage />} />
        <Route path="/artistsFilter" element={<ArtistsFilterPage />} />
      </Routes>
    </BrowserRouter>
  );
}
